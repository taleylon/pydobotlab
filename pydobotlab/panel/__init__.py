...
speed slider, home/clear-alarm, and live pose readout.

Launched via the ``pydobotlab-panel`` console script (added by
``pip install pydobotlab[gui]``) or ``python -m pydobotlab.panel``.
"""
